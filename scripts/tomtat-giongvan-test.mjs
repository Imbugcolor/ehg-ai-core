...
const HOI_THOAI = [
  { nguoi: 'Khách', luc: '09:12', body: 'Chào shop, mình đặt phòng ngày 20 tháng này qua Agoda, mã 8891234' },
  { nguoi: 'Nhân viên', luc: '09:20', body: 'Chào quý khách, chúng tôi đã nhận được đặt phòng ạ' },
  { nguoi: 'Khách', luc: '09:22', body: 'Mình muốn xin phòng tầng cao, tránh gần thang máy vì mình ngủ khó' },
  { nguoi: 'Nhân viên', luc: '09:30', body: 'Dạ chúng tôi đã ghi nhận, sẽ cố gắng sắp xếp' },
  { nguoi: 'Khách', luc: '14:05', body: 'Cho mình hỏi có xe đón sân bay không, chuyến mình hạ cánh 23h đêm' },
  { nguoi: 'Nhân viên', luc: '14:40', body: 'Dạ có ạ, để em kiểm tra lịch xe rồi báo lại quý khách' },
  { nguoi: 'Khách', luc: '18:20', body: 'Bạn ơi có kết quả xe chưa, mình cần chốt sớm để đặt vé' },
  { nguoi: 'Khách', luc: '21:15', body: 'Vẫn chưa thấy ai trả lời, mình hơi lo vì bay đêm' },
];
...
const t3 = await tomTat([...HOI_THOAI, { nguoi: 'Nhân viên', luc: '21:40', body: 'Dạ xe đã sắp xếp xong, tài xế đón quý khách lúc 23h15 ạ' }],
...
await sql(`
  insert into public.ai_tone (property_id, guest_type, lang, description, opening_line, closing_line, avoided_words)
  ...
  on conflict (property_id, guest_type, lang) do update
    set opening_line = excluded.opening_line, closing_line = excluded.closing_line, description = excluded.description;`);
xoaNhoTam();
